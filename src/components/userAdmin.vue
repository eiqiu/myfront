<template>
  ...
  <el-table
    ...
    <el-table-column
      ...
      width="120">
      <template slot-scope="scope">
        <el-switch v-model="scope.row.loginStatus" @click="userChange(scope.row)" @change="userStateChanged(scope.row)"></el-switch>
      </template>
    </el-table-column>
    <el-table-column
      prop="mobile"
    ...
    <el-dialog title="添加用户" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed">
      ...
      >
        ...
        <el-form-item>
            <el-select v-model="addUserForm.role" placeholder="请选择权限">
              <el-option
                v-for="item in roleoptions"
                :key="item.value"
                :label="item.label"
  ...
  methods: {
    ...
    addUser () {
      ...
      this.$refs.addUserFormRef.validate(async valid => {
        ...
        this.axios({
          method: 'POST',
          url: 'http://localhost:8081/back_war_exploded/addUser',
          data: {
            username: this.addUserForm.username,
            password: this.addUserForm.password,
            email: this.addUserForm.email,
            mobile: this.addUserForm.mobile,
            rolename: this.addUserForm.role
          }
        }).then(res => {
    ...
    userStateChanged (userInfo) {
      ...
      this.axios({
        method: 'GET',
        url: 'http://127.0.0.1:8008/service_war_exploded/users/type',
        params: {
          id: userInfo.id,
    ...
    async deleteById (index, tableData, row) {
      ...
      this.axios({
        method: 'GET',
        url: 'http://localhost:8081/back_war_exploded/users/delete?id=' + row.id
    ...
    editUser () {
      ...
      this.$refs.editUserFormRef.validate(async valid => {
        ...
        this.axios({
          method: 'POST',
          url: 'http://localhost:8081/back_war_exploded/users/updateUser',
          data: {
    ...
    changeRole (user) {
      ...
      this.axios({
        method: 'POST',
        url: 'http://localhost:8081/back_war_exploded/users/updateRole',
        data: {
          id: user.id,
    ...
    getUserList () {
      ...
      this.axios({
        method: 'GET',
        url: 'http://localhost:8081/back_war_exploded/userList',
        params: {
        ...
        vm.tableData = response.data.data.userVoList
  ...
  data () {
    ...
    return {
      tableData: [{
        ...
        mobile: '15066699889',
        email: '1252@qq.com',
        create_time: '2021-01-08 16:37:52',
        loginStatus: true,
        rolename: ''
      }],
      roleoptions: [
